...
import { createBanner, getBanners, resetData } from "../../store/banners";
...
export default function AddBanner({ showAdd, setShowAdd, loadBanners }) {
  ...
  const { createData, createFailed } = bannerData;
  ...
  const handleCreate = () => {
    //convert selected image to base 64
      ...
      >
        <Modal.Header closeButton className="modal-header">
          <Modal.Title id="contained-modal-title-vcenter">
            <Container>Create Banner</Container>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {addSuccess ? (
                        ...
                        <Row>
                          <Col xs={12}>
                            <div className="form-group">
                              <label>Choose podcast for this banner</label>
