...
import ChartClock from "../../../../assets/svg/chart-clock.svg";
import "./style.css";
...
export const ListeningMinutes = (props) => {
  const { showListeningDialog, setShowListeningDialog } = props;
  return (
    <PodDialog show={showListeningDialog} onHide={setShowListeningDialog}>
      <div className="published-modal-container">
        <div className="d-flex flex-column align-items-center">
          <div className="dashboard-modal--title">{props?.totalListeningMinutes} mins</div>
          <div className="dashboard-modal--sub-title">
            Total Listening <img src={ChartClock} alt="tick" />
          </div>
        </div>
