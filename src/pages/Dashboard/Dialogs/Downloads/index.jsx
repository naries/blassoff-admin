...
export const Downloads = (props) => {
  const { showDownloadsDialog, setShowDownloadsDialog } = props;
  return (
    <PodDialog show={showDownloadsDialog} onHide={setShowDownloadsDialog}>
      <div className="published-modal-container">
        <div className="d-flex flex-column align-items-center">
          <div className="dashboard-modal--title">{props?.totalEpisodesDownloads}</div>
          <div className="dashboard-modal--sub-title">
            Total Downloads <img src={ChartDownload} alt="tick" />
          </div>
        </div>
