...
import { contents, resetUpdateData, updateQuestion } from "../../../store/content";
...
export default function EditUser({ showEdit, setShowEdit, load, editPayload }) {
  ...
  const { updatingFree, updateFreeSuccess, updateFreeFailed } = contentsData;
  ...
  useEffect(() => {
    if (updateFreeSuccess) {
      setAddSuccess(true);
    }
    if (updateFreeFailed) {
      setAddFailure(true);
    }
  }, [updateFreeSuccess, updateFreeFailed]);
